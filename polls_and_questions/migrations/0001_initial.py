    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multiple_answers', models.BooleanField(verbose_name='allow multiple answer answer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('SYSTEM', 'Sistem user'), ('PARTICIPANT', 'Participant user')], max_length=20, verbose_name='user type')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls_and_questions.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='polls_and_questions.user')),
            ],
            options={
